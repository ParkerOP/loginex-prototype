        ...
        >
          ...
          <div className="relative flex flex-col items-center">
            <div className="flex items-end text-6xl font-extrabold tracking-tight text-foreground relative h-20">
                ...
                {/* squishable i */}
                <motion.div
                    className="relative mx-1 w-6 h-full flex flex-col justify-end"
                >
                    <motion.div
                        className="bg-foreground w-4 mx-auto rounded-sm"
                        animate={{
                            height: ["24px", "24px", "4px", "4px", "24px"],
                            opacity: [0, 1, 1, 1, 1]
                        }}
                        transition={{
                            duration: 3,
                            times: [0, 0.16, 0.43, 0.76, 0.83], // Scale times to 3s total
                            ease: "easeInOut"
                        }}
                        style={{ transformOrigin: "bottom" }}
                    />
                    <motion.div
                        className="w-4 h-4 bg-foreground rounded-full absolute top-0 left-1"
                        animate={{
                            y: [10, 10, 30, 30, 10],
                            opacity: [0, 1, 1, 1, 1],
                            scale: [1, 1, 0, 0, 1] // Dot disappears when squished
                        }}
                        transition={{
                            duration: 3,
                ...
                <motion.div
                    ...
                    initial={{ x: 300, y: -200, opacity: 0, scale: 0.5, rotate: 180 }}
                    animate={{
